...
export function libraryUI(ctx,{open,editor,insert}){
  ...
  return async function library(){
    ...
    const filters=element('div',null,'editor-grid');content.append(filters);const query={q:'',unit:'',kind:'cavity',manufacturer:'',cavity_type:'',thread:'',offset:0,limit:30};
    ...
    field(filters,'Record type',query.kind,v=>update('kind',v),{cavity:'Cavities',footprint:'Footprints',o_ring_groove:'O-ring grooves',undercut:'Undercuts',drill:'Drill tools',flat_bottom_drill:'Flat-bottom tools',spot_face:'Spot-face tools',material:'Material stock',assembly_envelope:'Assembly envelopes'});
