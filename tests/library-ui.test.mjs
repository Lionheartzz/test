...
test('Engineering Library active request renders and search replaces its result set',async()=>{
  const nodes={content:new Node('div'),error:new Node('div')},calls=[];
  const ctx={get:()=>({project_context:''}),$:(id)=>id==='workflow-content'?nodes.content:nodes.error,
